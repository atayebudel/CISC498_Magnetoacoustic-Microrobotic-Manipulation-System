...
#doesnt really work, isnt compatible with different controllers and operating systems. the continous connect/disconnect feature probably works but for now using old class
